<template>
	<div id="hospHome">
		...
		<div class="consultWrap">
			...
			<div class="riBut" @click="onlineService">立即咨询</div>
		</div>
	</div>
</template>
<style scoped>
...
<script>
	...
	import child2 from "./components/child2.vue";//真实案例
	import child3 from "./components/child3.vue";//本院医生
	import child4 from "./components/child4.vue";//执业资格
	import child5 from "./components/child5.vue";//品牌认证
	import child6 from "./components/child6.vue";//荣誉展示
	import child7 from "./components/child7.vue";//医院地址
	...
	export default {
		...
		methods: {
			...
			//在线咨询
			onlineService() {
				let params = {hospitalId:this.hospital_id};
