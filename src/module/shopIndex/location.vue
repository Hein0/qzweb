<template>
  ...
  <div class="-widget-top-bar">
    ...
    <div class="goBack" style="position: absolute;z-index: 9999;width: 0.8533rem;top: 1%;left: 2%;">
        <img src="./../shop/images/back.png"  @click='selectCity("flag")' style="width: 100%">
    </div>
  ...
  <div id="location-pop" style="display: block;transform-origin: 0px 0px 0px;opacity: 1;transform: scale(1, 1);">     
    <div class="list-wrapper" style="height:22.587rem;">         
      <div class="left-list" id="province_list">
  ...
  methods:{                                    
    ...
    selectCity(index){
      if(index=="flag"){
        ...
        this.$emit("close", this.city,this.provinceList[this.provinceActive].province)
      }
      // this.province=this.provinceList[index].province;

      
      //this.$router.push({path:'/index/shop', query: {city: this.city,province:this.provinceList[this.provinceActive].province}})
